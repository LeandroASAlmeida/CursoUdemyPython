...
A função reverse() só funciona em listas.##########     SOMENTE EM LISTAS

Já a função reversed() funciona com qualquer iterável.

Sua função é inverter o iterável.

A função reversed() retorna um iterável chamado List Reverse Iterator ###################  QUALQUER INTERAVEL( LISTA , TUPLAS )
