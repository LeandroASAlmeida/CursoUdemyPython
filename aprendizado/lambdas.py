...
nome_completo = lambda nome, sobrenome: nome.strip().title() + ' ' + sobrenome.strip().title()#strip= tira os espaçao dentro do inicio e fim da variavel. EX = ' gato ' ( .gato.)
#title = transformar a primeira letra  em maiuscula e o resto normal..
