...
print('br' in paises) # chave True
print('ru' in paises) # chave False
print('Estados Unidos' in paises) # valor == False
...
veja = {}.fromkeys('teste', 'valor') # {'t': 'valor', 'e': 'valor', 's': 'valor'} o 'te', não se repete pois não tem repetição em python
print(veja)

veja = {}.fromkeys(range(1, 11), 'novo')# {1: 'novo', 2: 'novo', 3: 'novo', 4: 'novo', 5: 'novo', 6: 'novo', 7: 'novo', 8: 'novo', 9: 'novo', 10: 'novo'}
